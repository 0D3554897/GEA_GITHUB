...
--new parameters for
--FDS, CCS - ftp commands and log files
...
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   ...
   VALUES(@INTERFACE_NAME_ID, 'FDS/CCS', 'FTP_FDS_COMMAND_FILE', 'D:\IMAPS_Data\NotShared\FDS_FTP_commands.txt', SUSER_SNAME(), GETDATE())
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   (INTERFACE_NAME_ID, INTERFACE_NAME_CD, PARAMETER_NAME, PARAMETER_VALUE, CREATED_BY, CREATED_DATE)
   VALUES(@INTERFACE_NAME_ID, 'FDS/CCS', 'FTP_FDS_LOG_FILE', 'D:\IMAPS_Data\NotShared\FDS_FTP_log.txt', SUSER_SNAME(), GETDATE())

INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   (INTERFACE_NAME_ID, INTERFACE_NAME_CD, PARAMETER_NAME, PARAMETER_VALUE, CREATED_BY, CREATED_DATE)
   VALUES(@INTERFACE_NAME_ID, 'FDS/CCS', 'FTP_CCS_LOG_FILE', 'D:\IMAPS_Data\NotShared\CCS_FTP_log.txt', SUSER_SNAME(), GETDATE())
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   (INTERFACE_NAME_ID, INTERFACE_NAME_CD, PARAMETER_NAME, PARAMETER_VALUE, CREATED_BY, CREATED_DATE)
   VALUES(@INTERFACE_NAME_ID, 'FDS/CCS', 'FTP_CCS_COMMAND_FILE', 'D:\IMAPS_Data\NotShared\CCS_FTP_commands.txt', SUSER_SNAME(), GETDATE())
...
set parameter_value='"D:\IMAPS_Data\NotShared\jdbc_connection.properties" no'
