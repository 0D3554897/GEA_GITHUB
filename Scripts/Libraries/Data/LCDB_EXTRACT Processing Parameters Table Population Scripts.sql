...
select @interface_name_id = LOOKUP_ID 
 ...
 where APPLICATION_CODE = 'LCDB_EXTRACT' 
...
INSERT INTO dbo.XX_PROCESSING_PARAMETERS 
   ...
   VALUES(@interface_name_id, 'LCDB_EXTRACT', 'IN_SOURCE_SYSOWNER', 'egf@us.ibm.com', SUSER_SNAME(), GETDATE())
go
...
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   (INTERFACE_NAME_ID, INTERFACE_NAME_CD, PARAMETER_NAME, PARAMETER_VALUE, CREATED_BY, CREATED_DATE) 
   VALUES(@interface_name_id, 'LCDB_EXTRACT', 'OUT_DESTINATION_SYSOWNER', 'egf@us.ibm.com', SUSER_SNAME(), GETDATE()) 
go
