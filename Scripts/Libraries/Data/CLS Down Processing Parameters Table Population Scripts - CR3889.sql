...
--new parameters for
--CLS  - ftp commands and log files
...
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   ...
   VALUES(@INTERFACE_NAME_ID, 'CLS', 'FTP_COMMAND_FILE', 'D:\IMAPS_Data\NotShared\CLS_FTP_commands.txt', SUSER_SNAME(), GETDATE())
INSERT INTO dbo.XX_PROCESSING_PARAMETERS
   (INTERFACE_NAME_ID, INTERFACE_NAME_CD, PARAMETER_NAME, PARAMETER_VALUE, CREATED_BY, CREATED_DATE)
   VALUES(@INTERFACE_NAME_ID, 'CLS', 'FTP_LOG_FILE', 'D:\IMAPS_Data\NotShared\CLS_FTP_log.txt', SUSER_SNAME(), GETDATE())



--update parameters and file path for CLS/CLS_R22 java properties file
update xx_processing_parameters
set parameter_value='"D:\IMAPS_Data\NotShared\jdbc_connection.properties"'
where interface_name_cd in ('CLS')
