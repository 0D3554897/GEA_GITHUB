...
/****** Object:  View [dbo].[XX_CCS_INTERFACE_DTL_VW]    Script Date: 09/13/2018 11:14:59 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[XX_CCS_INTERFACE_DTL_VW]'))
...
/****** Object:  View [dbo].[XX_CCS_INTERFACE_DTL_VW]    Script Date: 09/13/2018 11:15:00 ******/
SET ANSI_NULLS ON
GO
...
FILLER_01, AR_ACTV_IND, FDS_CUST_TYPE, AR_SOURCE, FILLER_02, CUST_REF1, CUST_REF2, FILLER_03, TIMEPAY, FILLER_04, COLLECTION_BO, FILLER_05, LATE_PAY_ID, FILLER_06A, C_INITIAL_ACT, FILLER_06B, TOT_TIME_PAY, FILLER_07, SHIP_DATE, IGF_LPF_AMT, FILLER_08, BUS_UNIT, PROD_ID, 
...
AND A.STATUS_FL <> 'E' 
and b.BILLED_AMT <> 0
GROUP BY CUST_PO_ID, CUST_ADDR_DC,A.INVC_ID,A.INVC_DT,TI_CMR_CUST_TYPE,T_CUST_REF_1,I_COLL_OFF 
