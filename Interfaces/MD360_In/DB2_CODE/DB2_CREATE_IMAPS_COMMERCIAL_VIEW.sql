-- IMAPS UNDERLYING QUERY FOR VIEW SAPR3.V_CI_USCMR_IMAPS_NONFED  (DIVISION 16)
-- 06/24/2022
-- GEORGE ALVAREZ, george.alvarez@us.ibm.com
-- Returns non-federal customers; created for occasional use where customers missing from SAPR3.V_CI_USCMR_IMAPS
