CREATE TABLE dbo.xx_R22_imaps_ts_prep_temp2
(
...
go
IF OBJECT_ID('dbo.xx_R22_imaps_ts_prep_temp2') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.xx_R22_imaps_ts_prep_temp2 >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.xx_R22_imaps_ts_prep_temp2 >>>'
go
