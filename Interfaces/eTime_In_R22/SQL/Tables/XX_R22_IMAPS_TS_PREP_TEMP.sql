CREATE TABLE dbo.XX_R22_IMAPS_TS_PREP_TEMP
(
...
go
IF OBJECT_ID('dbo.XX_R22_IMAPS_TS_PREP_TEMP') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_IMAPS_TS_PREP_TEMP >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_IMAPS_TS_PREP_TEMP >>>'
go
