CREATE TABLE dbo.XX_R22_IMAPS_ET_IN_UTIL
(
...
go
IF OBJECT_ID('dbo.XX_R22_IMAPS_ET_IN_UTIL') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_IMAPS_ET_IN_UTIL >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_IMAPS_ET_IN_UTIL >>>'
go
