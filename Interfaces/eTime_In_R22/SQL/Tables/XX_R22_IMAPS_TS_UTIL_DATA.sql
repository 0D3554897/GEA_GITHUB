CREATE TABLE dbo.XX_R22_IMAPS_TS_UTIL_DATA
(
...
go
IF OBJECT_ID('dbo.XX_R22_IMAPS_TS_UTIL_DATA') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_IMAPS_TS_UTIL_DATA >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_IMAPS_TS_UTIL_DATA >>>'
go
