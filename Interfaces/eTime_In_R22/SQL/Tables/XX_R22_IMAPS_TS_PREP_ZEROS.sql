CREATE TABLE dbo.XX_R22_IMAPS_TS_PREP_ZEROS
(
...
go
IF OBJECT_ID('dbo.XX_R22_IMAPS_TS_PREP_ZEROS') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_IMAPS_TS_PREP_ZEROS >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_IMAPS_TS_PREP_ZEROS >>>'
go
