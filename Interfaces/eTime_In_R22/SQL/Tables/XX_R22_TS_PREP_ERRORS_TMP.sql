...
go
IF OBJECT_ID('dbo.XX_R22_TS_PREP_ERRORS_TMP') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_TS_PREP_ERRORS_TMP >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_TS_PREP_ERRORS_TMP >>>'
go
