...
/****** Object:  View [dbo].[XX_CLS_999_FILE_VW]    Script Date: 03/05/2020 11:23:40 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[XX_CLS_999_FILE_VW]'))
...
/****** Object:  View [dbo].[XX_CLS_999_FILE_VW]    Script Date: 03/05/2020 11:23:41 ******/
SET ANSI_NULLS ON
GO
