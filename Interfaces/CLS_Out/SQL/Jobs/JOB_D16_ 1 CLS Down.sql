...
/****** Object:  Job [D16_ 1 CLS Down]    Script Date: 4/7/2020 10:51:37 AM ******/
EXEC msdb.dbo.sp_delete_job @job_id=N'caa2a2a7-0c36-4cd6-ab68-6724c307e46e', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 4/7/2020 10:51:37 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [MAKE SURE CLOSEOUT WAS RUN]    Script Date: 4/7/2020 10:51:38 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [VALIDATE CLS FILES]    Script Date: 4/7/2020 10:51:38 AM ******/
...
', 
		...
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [VALIDATE JAVA AND FTP WORKS]    Script Date: 4/7/2020 10:51:38 AM ******/
...
PRINT ''************************************************************''', 
		...
		@flags=2
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [run interface]    Script Date: 4/7/2020 10:51:38 AM ******/
