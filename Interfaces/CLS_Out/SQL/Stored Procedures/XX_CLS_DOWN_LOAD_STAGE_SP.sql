...
PRINT '***********************************************************************************************************************'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 1. TRUNCATE TABLES'
...
/********** DR 7888 CHANGES DETAIL INSERT TO ELIMINATE REVENUE ACCOUNTS WITH FILTER **************/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 2. GL DETAIL INSERT'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
...
****************************************************************************************/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 3.  REVENUE INSERT'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
...
*************************** END LEGACY CODE REPLACED BY DR 7888 ******************************************/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 4.	DIRECT BURDEN INSERTS'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
...
0
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 5.	NON-DIRECT BURDEN INSERTS'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 6.	DELETE ZERO DOLLAR BURDEN RECORDS'	
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 7.	FDS REVERSE INSERT'	
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 8.	PROJECT RELATED DATA MAPPINGS'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	/* ACCOUNT MAPPINGS */
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 9.	FDS REVERSE ACCOUNT MAPPING'
	/*
	...
	*/	
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 10.	BURDEN ACCOUNT MAPPING'	
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'PERFORM CLS ACCOUNT MAPPING'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 11.	GL AND REVENUE ACCOUNT MAPPING'	
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'PERFORM CLS ACCOUNT MAPPING'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 12.	APPLY NEW MAJORS/MINORS TO PROJECTS WITH CERTAIN OCC VALUES'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 13.	SERVICE OFFERING DATA'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
...
--END
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 14.	MEMO ENTRY INSERTS'	
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 15.	MANUFACTURED PL & GL BURDEN VARIANCE TRANSACTION'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 16.	MANUFACTURED FILE BALANCE TRANSACTION'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
...
SET @DIVISION = '1M'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 17.	UPDATE CUSTOMER CMR DATA'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## UPDATE CMR FOR ABOVE BILLING LEVEL - part 1'
	update XX_CLS_DOWN_THIS_MONTH_YTD
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## INSERT new XX_CLS_DOWN_PROJ_CUST_ABOVE_BILLING_LEVEL'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## UPDATE CMR FOR ABOVE BILLING LEVEL - part 2'
	update XX_CLS_DOWN_THIS_MONTH_YTD
	set customer_num=pc.addr_dc
	from 
	XX_CLS_DOWN_THIS_MONTH_YTD cls
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP UPDATE CMR DATA - standard'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_THIS_MONTH_YTD'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 18. UPDATE CMR DATA - customer number dropped from CMR feed'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## UPDATE CMR DATA - true defaults'
	--end CR4563
 ...
 IS NULL 
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 19.	UPDATE DESCRIPTION2'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_THIS_MONTH_YTD'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 20.	DELETE ZERO DOLLAR TRANSACTIONS'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'DELETE ZERO DOLLAR TRANSACTION'
	SET @error_msg_placeholder2 = 'FROM XX_CLS_DOWN_THIS_MONTH_YTD'
	...
	********/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 21. STEP MOVED. NO TRANSFORMATION AT THIS TIME'


	-- PRINT '20.	THIS STEP NO LONGER EXISTS - DR7888'
/************* THIS IS FOR DIVISION 16 ONLY *********************/

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 22. APPLY REPORTING PROJECT PROJ_ID SUBSTITUTIONS'
	
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 22(A) UPDATE ARCHIVE TO SHOW REPORTING PROJECTS FROM UDEF LABEL KEY = 60'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	/*********** FSSTIMAPS-73 IS PUT ON HOLD

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 22(B) UPDATE MULTI-PROJECT REVENUE LEVELS WITH DEFAULT REPORTING PROJECT'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_YTD_ARCHIVE'
	...
	set IMAPSSTG.DBO.XX_CLS_DOWN_YTD_ARCHIVE.GENL_ID = VW.GENL_ID,
	IMAPSSTG.DBO.XX_CLS_DOWN_YTD_ARCHIVE.UDEF_TXT = VW.UDEF_TXT,
	IMAPSSTG.DBO.XX_CLS_DOWN_YTD_ARCHIVE.FULL_PROJ_ID = YA.IMAPS_PROJ_ID
	FROM IMAPSSTG.DBO.XX_CLS_DOWN_YTD_ARCHIVE YA, 
	IMAPSSTG.DBO.XX_REV_LVL_UDEF_PROJ_VW VW
	WHERE CHARINDEX(YA.IMAPS_PROJ_ID, VW.GENL_ID) > 0
	--CONTAINS(YA.IMAPS_PROJ_ID, VW.GENL_ID)
	--YA.IMAPS_PROJ_ID = VW.GENL_ID
	AND YA.IMAPS_PROJ_ID IS NOT NULL
	AND YA.STATUS_RECORD_NUM = @in_STATUS_RECORD_NUM
	...
	**************************************************************************/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 22(C) UPDATE ARCHIVE WHERE NO MATCHING REPORTING PROJECTS FROM UDEF LABEL KEY = 60'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_YTD_ARCHIVE'
	SET @error_msg_placeholder2 = 'USING DEFAULT REPORTING PROJECT'	
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 22(D) UPDATE YTD IMAPS_PROJ_ID WITH REPORTING PROJECT SAVED IN ARCHIVE'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
    ...
    -- CHANGE THE IGS_PROJ TO THE LAST FOUR OF THE REPORTING PROJECT
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23. APPLY OEM TRANSFORMATIONS' 
    -- A. TEMPORARILY UPDATE DIVISION TO REPORTING DIVISION
	-- B. UPDATE MAJOR, MINOR, PRODUCT ID WHERE DIVISION IN MAP
	-- C. UPDATE MAJOR, MINOR, PRODUCT ID WHERE DIVISION NOT IN MAP
	-- D. REVERSE EXISTING REVENUE ENTRY HW
	-- E. REVERSE EXISTING REVENUE ENTRY SW
	-- F. CREATE REVENUE ENTRY - HW
	-- G. CREATE REVENUE ENTRY - SW
	-- H. RESTORE DIVISION 16
	-- I. UPDATE CUSTOMER DATA FROM CMR

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(A) TEMPORARILY UPDATE DIVISION TO REPORTING DIVISION (EXPENSES)'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'TEMPORARY UPDATE XX_CLS_DOWN_YTD'
	SET @error_msg_placeholder2 = 'WITH REPORTING DIVISION'		
 
	UPDATE IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
	SET	DIVISION = IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id)
	WHERE 
	IMAPS_ACCT IN (SELECT DISTINCT IMAPS_ACCT FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'EXP')

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(B) UPDATE THE MAJOR/MINOR/PRODUCT_ID WHERE THE ACCOUNT AND DIVISION ARE IN THE MAP'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_YTD'
	SET @error_msg_placeholder2 = 'WITH MAJOR/MINOR/PRODUCT_ID'		

	UPDATE IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
	SET CLS_MAJOR = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'MAJ'),
	CLS_MINOR = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'MIN'),
	PRODUCT_ID = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'PID')
	FROM 
		IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD Y 
		INNER JOIN IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP M
		ON Y.IMAPS_ACCT = M.IMAPS_ACCT
		   AND Y.DIVISION = M.DIVISION
	WHERE Y.IMAPS_ACCT IN (SELECT IMAPS_ACCT FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'EXP')
		AND Y.DIVISION IN (SELECT DIVISION FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'EXP')

	-- BUT WHAT IF THE DIVISION IS NOT IN THE MAP - USE DIVISION 70
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(C) UPDATE THE MAJOR/MINOR/PRODUCT_ID TO DIVISION 70 WHERE THE DIVISION NOT IN THE MAP'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN_YTD'
	SET @error_msg_placeholder2 = 'WITH DEFAULT MAJOR/MINOR/PRODUCT_ID'		

	UPDATE IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
	SET CLS_MAJOR = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT,'70','MAJ'),
	CLS_MINOR = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, '70','MIN'),
	PRODUCT_ID = IMAPSSTG.DBO.XX_GET_OEM_EXP_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, '70','PID')
	FROM 
		IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD Y 
		INNER JOIN IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP M
		ON Y.IMAPS_ACCT = M.IMAPS_ACCT
		   AND Y.DIVISION = '70'
	WHERE Y.IMAPS_ACCT IN (SELECT IMAPS_ACCT FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'EXP')
		AND Y.DIVISION NOT IN (SELECT DIVISION FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'EXP')
...
select imaps_acct, cls_major, description2, imaps_proj_id, 
IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id),
IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id)+'3','MAJ'), 
(dollar_amt)
from
IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD 
WHERE  1=1
   and IMAPS_ACCT = ''
   -- IN ('43-15-40')
	-- (SELECT  DISTINCT IMAPS_ACCT FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP)
	--and charindex('Accrual - OEM', description2) >0
	and charindex('OEM', description2) >0
--group by cls_major, description2, imaps_acct

*****/


	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(D) CREATE REVERSING ENTRY FOR HW'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'INSERT HW REVENUE REVERSALS INTO'
	SET @error_msg_placeholder2 = 'XX_CLS_DOWN_YTD'		

	INSERT INTO IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
		(CLS_MAJOR,CLS_MINOR,CLS_SUB_MINOR,IMAPS_ACCT,IMAPS_PROJ_ID,L1_PROJ_SEG_ID,
		  DOLLAR_AMT,CONTRACT_NUM,IGS_PROJ,SERVICE_OFFERING,CUSTOMER_NUM, MACHINE_TYPE_CD, PRODUCT_ID, DESCRIPTION2, DIVISION) 
	SELECT 	COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'MAJ'),Y.CLS_MAJOR) AS MAJ,
			COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'MIN'),Y.CLS_MINOR) AS MNR,
			COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'SUB'),Y.CLS_SUB_MINOR) AS SUB,
			'', 
			IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(Y.IMAPS_PROJ_ID), --REVENUE LEVEL
			LEFT(IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(Y.IMAPS_PROJ_ID),4), --CONTRACT_NUM
			SUM(DOLLAR_AMT),
			CONTRACT_NUM, 
			IGS_PROJ, 
			IMAPSSTG.DBO.XX_GET_SERVICE_OFFERING_UF(Y.IMAPS_PROJ_ID), -- SERVICE OFFERING 
			IMAPSSTG.DBO.XX_GET_CUSTOMER_FOR_PROJECT_UF(Y.IMAPS_PROJ_ID), -- CUSTOMER NUMBER 
			IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'PID'),--MACHINE_TYPE_CD
			IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'PID'),--PRODUCT_ID
			'REVERSE HW CP OEM REV REC',
			Y.DIVISION
	FROM 
		IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD Y 
		INNER JOIN IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP M
		ON Y.IMAPS_ACCT = M.IMAPS_ACCT
		   AND Y.DIVISION = M.DIVISION
	WHERE Y.DIVISION IN (SELECT DISTINCT DIVISION FROM  IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'REV')
			AND Y.CONTRACT_NUM <> 'PSTOP'
			AND Y.IGS_PROJ <> '144F'
			AND M.HWSW = 'HW'
	GROUP BY Y.CLS_MAJOR, Y.CLS_MINOR, Y.CLS_SUB_MINOR, Y.IMAPS_ACCT, Y.IMAPS_PROJ_ID,
			--IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID), --REVENUE LEVEL
			L1_PROJ_SEG_ID, -- SUM(DOLLAR_AMT), SUM(COALESCE(GA_AMT,0)), SUM(COALESCE(OVERHEAD_AMT,0)),  
			CONTRACT_NUM, IGS_PROJ, --SERVICE_OFFERING, --CUSTOMER_NUM,-- MACHINE_TYPE_CD, --Y.PRODUCT_ID, 
			DESCRIPTION2, CONSOLIDATED_REV_BRANCH_OFFICE, INDUSTRY, ENTERPRISE_NUM_CD, Y.DIVISION
	...
	INSERT INTO IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
		(CLS_MAJOR,CLS_MINOR,CLS_SUB_MINOR,Y.IMAPS_ACCT,IMAPS_PROJ_ID,L1_PROJ_SEG_ID,
		  DOLLAR_AMT,CONTRACT_NUM,IGS_PROJ,SERVICE_OFFERING,CUSTOMER_NUM, MACHINE_TYPE_CD, PRODUCT_ID, DESCRIPTION2, DIVISION) 
	SELECT 	COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'MAJ'),Y.CLS_MAJOR) MAJ,
			COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'MIN'),Y.CLS_MINOR) MNR,
			COALESCE(IMAPSSTG.DBO.XX_BM_DIV_MMS_UF(IMAPSSTG.DBO.SB_GET_BUS_MEAS_DIV_CD_UF(imaps_proj_id) + COALESCE(LEFT(Y.IMAPS_ACCT,1),'3'),'SUB'),Y.CLS_SUB_MINOR) SUB,
			'', 
			IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID), --REVENUE LEVEL
			LEFT(IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID),4), --CONTRACT_NUM
			SUM(DOLLAR_AMT),
			CONTRACT_NUM, 
			IGS_PROJ, 
			IMAPSSTG.DBO.XX_GET_SERVICE_OFFERING_UF(IMAPS_PROJ_ID), -- SERVICE OFFERING 
			IMAPSSTG.DBO.XX_GET_CUSTOMER_FOR_PROJECT_UF(IMAPS_PROJ_ID), -- CUSTOMER NUMBER 
			IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'PID'),--MACHINE_TYPE_CD
			IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'PID'),--PRODUCT_ID
			'REVERSE SW CP OEM REV REC',
			Y.DIVISION
	FROM 
		IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD Y 
		INNER JOIN IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP M
	...
	WHERE Y.DIVISION IN (SELECT DISTINCT DIVISION FROM  IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'REV')
			...
			AND Y.IGS_PROJ <> '144F'
			AND M.HWSW = 'SW'
	GROUP BY Y.CLS_MAJOR, Y.CLS_MINOR, Y.CLS_SUB_MINOR, Y.IMAPS_ACCT, IMAPS_PROJ_ID,
			--IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID), --REVENUE LEVEL
			L1_PROJ_SEG_ID, -- SUM(DOLLAR_AMT), SUM(COALESCE(GA_AMT,0)), SUM(COALESCE(OVERHEAD_AMT,0)),  
			CONTRACT_NUM, IGS_PROJ, --SERVICE_OFFERING, --CUSTOMER_NUM,-- MACHINE_TYPE_CD, --Y.PRODUCT_ID, 
			DESCRIPTION2, CONSOLIDATED_REV_BRANCH_OFFICE, INDUSTRY, ENTERPRISE_NUM_CD, Y.DIVISION
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(F) CREATE REVENUE ENTRY LINES FOR HW'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'INSERT HW OEM REVENUE INTO'
	SET @error_msg_placeholder2 = 'XX_CLS_DOWN_YTD'		

	INSERT INTO IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
		(CLS_MAJOR,CLS_MINOR,CLS_SUB_MINOR,IMAPS_ACCT,IMAPS_PROJ_ID,L1_PROJ_SEG_ID,
		  DOLLAR_AMT,CONTRACT_NUM,IGS_PROJ,SERVICE_OFFERING,CUSTOMER_NUM, MACHINE_TYPE_CD, PRODUCT_ID, DESCRIPTION2, DIVISION) 
	SELECT 	IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT,Y.DIVISION,'MAJ'),
			IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT,Y.DIVISION,'MIN'),
			COALESCE(IMAPSSTG.DBO.XX_GET_OEM_REV_VALUES_BY_DIV_UF(Y.IMAPS_ACCT, Y.DIVISION,'SUB'),'0000'),
			'', 
			IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID), --REVENUE LEVEL
			LEFT(IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID),4), --CONTRACT_NUM
			-1* SUM(DOLLAR_AMT),
	...
	WHERE Y.DIVISION IN (SELECT DISTINCT DIVISION FROM  IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP WHERE CLASS = 'REV')
			...
			AND Y.IGS_PROJ <> '144F'
			AND M.HWSW = 'HW'
	GROUP BY Y.CLS_SUB_MINOR, Y.IMAPS_ACCT, IMAPS_PROJ_ID,
			--IMAPSSTG.DBO.XX_GET_REV_PROJ_FROM_PROJ_UF(IMAPS_PROJ_ID), --REVENUE LEVEL
			L1_PROJ_SEG_ID, -- SUM(DOLLAR_AMT), SUM(COALESCE(GA_AMT,0)), SUM(COALESCE(OVERHEAD_AMT,0)),  
			CONTRACT_NUM, IGS_PROJ, --SERVICE_OFFERING, --CUSTOMER_NUM,-- MACHINE_TYPE_CD, --Y.PRODUCT_ID, 
			DESCRIPTION2, CONSOLIDATED_REV_BRANCH_OFFICE, INDUSTRY, ENTERPRISE_NUM_CD, Y.DIVISION
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(G) CREATE REVENUE ENTRY LINES FOR SW'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'INSERT SW OEM REVENUE INTO'
	SET @error_msg_placeholder2 = 'XX_CLS_DOWN_YTD'		
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(H) RESTORE DIVISION 16'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'RESTORE XX_CLS_DOWN_YTD'
	SET @error_msg_placeholder2 = 'WITH DIVISION 16'		

	UPDATE IMAPSSTG.DBO.XX_CLS_DOWN_THIS_MONTH_YTD
	SET	DIVISION = @DIVISION
	WHERE
	IMAPS_ACCT IN (SELECT DISTINCT IMAPS_ACCT FROM IMAPSSTG.DBO.XX_CLS_DOWN_HW_SW_MAP)

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 23(I) UPDATE CMR INFO'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'RESTORE XX_CLS_DOWN_YTD'
	SET @error_msg_placeholder2 = 'WITH DIVISION 16'	
	...
	FROM XX_IMAPS_CMR_STG Y
	WHERE Y.I_CUST_ENTITY =  CUSTOMER_NUM 
	AND IMAPS_ACCT IN ('43-15-97','43-15-98')
	AND DESCRIPTION2 IN ('OEM HW ACCRUAL', 'OEM SW ACCRUAL')


/************* THIS IS FOR DIVISION 16 ONLY *********************/

	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 24.	ARCHIVE YTD IMAGE'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 25.	CALCULATE DIFFERENCE BETWEEN THIS MONTH AND LAST MONTH VALUES'
...
***********************************************************************************************************************************************************
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 20.	CALCULATE SIMPLE DIFFERENCE BETWEEN THIS MONTH AND LAST MONTH VALUES'
	 VALUES THAT HAVE CHANGED SINCE THE PREVIOUS MONTH 
	OR VALUES THAT DID NOT EXIST IN THE PREVIOUS MONTH 
...
IS.CLS_MAJOR, THIS.CLS_MINOR, THIS.CLS_SUB_MINOR,
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 21.	CALCULATE COMPLEX DIFFERENCE BETWEEN THIS MONTH AND LAST MONTH VALUES'
...
*/
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 26.	PERFORM PROJECT CODE DEFAULTING'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 26.A UPDATE PROJ_ABBRV_CD'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN'
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP 26.B - UPDATE SERVICE OFFERING'
	SET @IMAPS_error_number = 204 -- Attempt to %1 %2 failed.
	SET @error_msg_placeholder1 = 'UPDATE XX_CLS_DOWN'
...
'CSI','BTO','WEB') THEN @IGSPROJ_FOR16
	...
	PRINT 'TIME:' + CAST(CAST(GETDATE() AS TIME) AS VARCHAR(5)) + ' ## STEP LAST - SUCCESSFULLY REACHED END OF XX_CLS_DOWN_LOAD_STAGE_SP.SQL; NEXT - dbo.XX_CLS_DOWN_VALIDATE_CMR_SP'
