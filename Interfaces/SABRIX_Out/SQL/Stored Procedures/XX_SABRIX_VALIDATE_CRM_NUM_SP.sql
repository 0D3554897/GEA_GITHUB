...
/****** Object:  StoredProcedure [dbo].[XX_SABRIX_VALIDATE_CMR_NUM_SP]    Script Date: 01/18/2018 13:50:36 ******/

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[XX_SABRIX_VALIDATE_CMR_NUM_SP]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
