...
/****** Object:  StoredProcedure [dbo].[XX_SABRIX_LOAD_SUM_SP]    Script Date: 01/18/2018 13:54:14 ******/

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[XX_SABRIX_LOAD_SUM_SP]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
