...
/****** Object:  View [dbo].[XX_SABRIX_INTERFACE_DTL_VW]    Script Date: 09/13/2018 11:14:59 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[XX_SABRIX_INTERFACE_DTL_VW]'))
...
/****** Object:  View [dbo].[XX_SABRIX_INTERFACE_DTL_VW]    Script Date: 09/13/2018 11:15:00 ******/
SET ANSI_NULLS ON
GO
