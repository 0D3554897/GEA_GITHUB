...
/****** Object:  View [dbo].[XX_SABRIX_INTERFACE_TRX_VW]    Script Date: 02/08/2019 13:56:37 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[XX_SABRIX_INTERFACE_TRX_VW]'))
