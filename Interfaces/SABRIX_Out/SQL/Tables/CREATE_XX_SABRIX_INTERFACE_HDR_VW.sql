...
/****** Object:  View [dbo].[XX_SABRIX_INTERFACE_HDR_VW]    Script Date: 02/07/2019 08:57:48 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[XX_SABRIX_INTERFACE_HDR_VW]'))
