-- Added CR-2350
CREATE TABLE dbo.XX_R22_CERIS_RETRO_TS_PREP_HOLD
(
...
go
IF OBJECT_ID('dbo.XX_R22_CERIS_RETRO_TS_PREP_HOLD') IS NOT NULL
    PRINT '<<< CREATED TABLE dbo.XX_R22_CERIS_RETRO_TS_PREP_HOLD >>>'
ELSE
    PRINT '<<< FAILED CREATING TABLE dbo.XX_R22_CERIS_RETRO_TS_PREP_HOLD >>>'
go
