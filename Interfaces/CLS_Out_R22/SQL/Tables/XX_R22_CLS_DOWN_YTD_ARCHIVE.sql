...
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[XX_R22_CLS_DOWN_YTD_ARCHIVE]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
   DROP TABLE [dbo].[XX_R22_CLS_DOWN_YTD_ARCHIVE]
GO

CREATE TABLE [dbo].[XX_R22_CLS_DOWN_YTD_ARCHIVE](
	...
	CONSTRAINT [FK_XX_R22_CLS_DOWN_YTD_ARCHIVE] FOREIGN KEY 
	(
		[STATUS_RECORD_NUM]
